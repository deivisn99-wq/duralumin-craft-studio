      ...
      <div className="mx-auto max-w-7xl px-5 lg:px-8">
        ...
        <div className="mt-14 grid grid-cols-1 md:grid-cols-3 gap-6">
          {projectImages.map((image, i) => (
            <Reveal key={labels[i]} delay={i * 70}>
              <div className="relative aspect-[4/5] rounded-2xl overflow-hidden group border border-white/10">
                <button
                  type="button"
                  onClick={() => setActive(i)}
                  className="group relative block h-full w-full bg-brown text-left focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-beige"
                >
                  <img
                    src={image}
                    ...
                    width={900}
                    height={1200}
                    className="h-full w-full object-cover transition duration-700 group-hover:scale-105 group-hover:opacity-75"
                  />
