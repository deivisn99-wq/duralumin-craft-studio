...
export const content = {
  al: {
    ...
    hero: {
      title: "Dritare Alumini me Precizion. Punuar për të Zgjatur.",
      sub: "Prodhim dhe montim profesional i dritareve dhe dyerve prej alumini në Tiranë — cilësi e lartë, korrektësi në punë, çmimet më konkurruese në treg.",
    ...
    why: {
      ...
      pillars: [
        ...
        {
          t: "Çmime Konkurruese",
          d: "Oferta të detajuara dhe transparente, me çmime nga më konkurrueset në treg — pa kosto të fshehura.",
        },
  ...
  en: {
    ...
    hero: {
      ...
      sub: "Professional fabrication and installation of aluminum windows and doors in Tiranë — premium materials, honest workmanship, the most competitive prices in the market.",
      cta1: "Get a Free Quote",
      cta2: "See Our Work",
      trust: "★ 4.9/5 · 28 Google reviews",
      eyebrow: "Aluminum Fabrication · Tiranë",
    },
    about: {
      label: "About",
    ...
    why: {
      ...
      pillars: [
        ...
        { t: "Reliability & Honesty", d: "Deadlines respected and straightforward communication." },
        {
          ...
          d: "Detailed, transparent quotes at the most competitive prices in the market — with no hidden costs.",
        },
...
export const reviews = [
  {
    ...
    text: {
      ...
      en: "Very high quality of materials and excellent workmanship and correctness in the work they do, with the cheapest prices on the market.",
    },
  },
  {
    ...
    text: {
      ...
      en: "Very high quality work. Reliability and correctness in service.",
    },
  },
  {
    name: "Ervis Kamberaj",
